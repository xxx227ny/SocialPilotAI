...
class WanxProductImageService:
    ...
    def _prompt(product, version, scene) -> str:
        ...
        return (
            ...
            "If the scene or action mentions pressing a button, charging, a cable, "
            "a port, a link, or any interface, express only the intended benefit and "
            "never render that named object unless it is visibly present in the "
            "reference image. Never add, move, or redesign buttons, ports, cables, "
            "latches, controls, blades, lids, or seams. Show operation only through "
            "the ingredients, liquid motion, natural hand placement, and the unchanged "
            "product. "
